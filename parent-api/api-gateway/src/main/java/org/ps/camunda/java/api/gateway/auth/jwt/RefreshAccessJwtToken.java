...
final class RefreshAccessJwtToken implements JwtToken {
	...
	public RefreshAccessJwtToken(final Jws<Claims> claims) {
		this.claims = claims;
	}
	 ...
	 * @return
	 */
	public static Optional<RefreshAccessJwtToken> of(final JwtTokenRaw token, final String signingKey) {
